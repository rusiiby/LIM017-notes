...
import { insertNewLink, getLinks, updateNote, deleteNote } from '../firebase/firebase';
    ...
    <DashboardWrapper>
        <div>
           ...
           <form className={style.entryContainer} action="" onSubmit={handleOnSubmit}>
            ...
            <textarea name="description" id="text" cols="30" rows="10" onChange={handleOnChange}></textarea>
